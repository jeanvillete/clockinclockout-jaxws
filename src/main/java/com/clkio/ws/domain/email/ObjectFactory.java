 ...
 * generated in the com.clkio.ws.domain.email package. 
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.clkio.ws.domain.email
     * 
     */
