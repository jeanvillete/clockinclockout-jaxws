...
insert into day(id, date, expected_hours, id_profile) values (nextval('day_seq'),'2015-07-02', '8 hours', ( select id from profile where description = 'default profile' ) );
...
insert into day(id, date, expected_hours, id_profile) values (nextval('day_seq'),'2015-07-03', '8 hours', ( select id from profile where description = 'default profile' ) );
...
insert into day(id, date, expected_hours, id_profile) values (nextval('day_seq'),'2015-07-06', '8 hours', ( select id from profile where description = 'default profile' ) );
...
insert into day(id, date, expected_hours, id_profile) values (nextval('day_seq'),'2015-07-07', '8 hours', ( select id from profile where description = 'default profile' ));
...
insert into day(id, date, expected_hours, id_profile) values (nextval('day_seq'),'2015-07-08', '8 hours', ( select id from profile where description = 'default profile' ) );
...
insert into day(id, date, expected_hours, notes, id_profile) values ( nextval('day_seq'),'2015-07-09', '0', 'feriado 9 de julho, definir requisitos emAdapter junto ao Cabelo', ( select id from profile where description = 'default profile' ) );
...
insert into day(id, date, expected_hours, id_profile) values (nextval('day_seq'),'2015-07-10', '8 hours', ( select id from profile where description = 'default profile' ) );
...
insert into day(id, date, expected_hours, id_profile) values (nextval('day_seq'),'2015-07-13', '8 hours', ( select id from profile where description = 'default profile' ) );
...
insert into day(id, date, expected_hours, id_profile) values (nextval('day_seq'),'2015-07-14', '8 hours', ( select id from profile where description = 'default profile' ) );
...
insert into day(id, date, expected_hours, id_profile) values (nextval('day_seq'),'2015-07-15', '8 hours', ( select id from profile where description = 'default profile' ) );
...
insert into day(id, date, expected_hours, notes, id_profile) values ( nextval('day_seq'),'2015-07-16', '8 hours', 'Este dia eu e o cabelo fomos para SP',( select id from profile where description = 'default profile' ) );
...
insert into day(id, date, expected_hours, id_profile) values (nextval('day_seq'),'2015-07-17', '8 hours', ( select id from profile where description = 'default profile' ) );
...
insert into day(id, date, expected_hours, id_profile) values (nextval('day_seq'),'2015-07-20', '8 hours', ( select id from profile where description = 'default profile' ) );
...
insert into day(id, date, expected_hours, id_profile) values (nextval('day_seq'),'2015-07-21', '8 hours', ( select id from profile where description = 'default profile' ) );
...
insert into day(id, date, expected_hours, id_profile) values (nextval('day_seq'),'2015-07-22', '8 hours', ( select id from profile where description = 'default profile' ) );
...
insert into day(id, date, expected_hours, id_profile) values (nextval('day_seq'),'2015-07-23', '8 hours', ( select id from profile where description = 'default profile' ) );
...
insert into day(id, date, expected_hours, id_profile) values (nextval('day_seq'),'2015-07-24', '8 hours', ( select id from profile where description = 'default profile' ) );
...
insert into day(id, date, expected_hours, id_profile) values (nextval('day_seq'),'2015-07-27', '8 hours', ( select id from profile where description = 'default profile' ) );
...
insert into day(id, date, expected_hours, id_profile) values (nextval('day_seq'),'2015-07-28', '8 hours', ( select id from profile where description = 'default profile' ) );
...
insert into day(id, date, expected_hours, id_profile) values (nextval('day_seq'),'2015-07-29', '8 hours', ( select id from profile where description = 'default profile' ) );
...
insert into day(id, date, expected_hours, id_profile) values (nextval('day_seq'),'2015-07-30', '8 hours', ( select id from profile where description = 'default profile' ) );
...
insert into day(id, date, expected_hours, id_profile) values (nextval('day_seq'),'2015-07-31', '8 hours', ( select id from profile where description = 'default profile' ) );
...
insert into day(id, date, expected_hours, id_profile) values (nextval('day_seq'),'2015-08-03', '8 hours', ( select id from profile where description = 'default profile' ) );
...
insert into day(id, date, expected_hours, id_profile) values (nextval('day_seq'),'2015-08-04', '8 hours', ( select id from profile where description = 'default profile' ) );
...
insert into day(id, date, expected_hours, id_profile) values (nextval('day_seq'),'2015-08-05', '8 hours', ( select id from profile where description = 'default profile' ) );
...
insert into day(id, date, expected_hours, id_profile) values (nextval('day_seq'),'2015-08-06', '8 hours', ( select id from profile where description = 'default profile' ) );
...
insert into day(id, date, expected_hours, id_profile) values (nextval('day_seq'),'2015-08-07', '8 hours', ( select id from profile where description = 'default profile' ) );
...
insert into day(id, date, expected_hours, id_profile) values (nextval('day_seq'),'2015-08-10', '8 hours', ( select id from profile where description = 'default profile' ) );
...
insert into day(id, date, expected_hours, id_profile) values (nextval('day_seq'),'2015-08-11', '8 hours', ( select id from profile where description = 'default profile' ) );
...
insert into day(id, date, expected_hours, id_profile) values (nextval('day_seq'),'2015-08-12', '8 hours', ( select id from profile where description = 'default profile' ) );
...
insert into day(id, date, expected_hours, id_profile) values (nextval('day_seq'),'2015-08-13', '8 hours', ( select id from profile where description = 'default profile' ) );
...
insert into day(id, date, expected_hours, id_profile) values (nextval('day_seq'),'2015-08-14', '8 hours', ( select id from profile where description = 'default profile' ) );
...
insert into day(id, date, expected_hours, id_profile) values (nextval('day_seq'),'2015-08-17', '8 hours', ( select id from profile where description = 'default profile' ) );
...
insert into day(id, date, expected_hours, id_profile) values (nextval('day_seq'),'2015-08-18', '8 hours', ( select id from profile where description = 'default profile' ) );
...
insert into day(id, date, expected_hours, id_profile) values (nextval('day_seq'),'2015-08-19', '8 hours', ( select id from profile where description = 'default profile' ) );
...
insert into day(id, date, expected_hours, id_profile) values (nextval('day_seq'),'2015-08-20', '8 hours', ( select id from profile where description = 'default profile' ) );
...
insert into day(id, date, expected_hours, id_profile) values (nextval('day_seq'),'2015-08-21', '8 hours', ( select id from profile where description = 'default profile' ) );
...
insert into day(id, date, expected_hours, id_profile) values (nextval('day_seq'),'2015-08-24', '8 hours', ( select id from profile where description = 'default profile' ) );
...
insert into day(id, date, expected_hours, notes, id_profile) values ( nextval('day_seq'),'2015-08-25', '8 hours', 'SERVIÇO EXTERNO (Fui para o DB neste dia para conversar com Kiyohara e Giuliano a respeito do projeto FX)',( select id from profile where description = 'default profile' ) );
...
insert into day(id, date, expected_hours, id_profile) values (nextval('day_seq'),'2015-08-26', '8 hours', ( select id from profile where description = 'default profile' ) );
...
insert into day(id, date, expected_hours, id_profile) values (nextval('day_seq'),'2015-08-27', '8 hours', ( select id from profile where description = 'default profile' ) );
...
insert into day(id, date, expected_hours, id_profile) values (nextval('day_seq'),'2015-08-28', '8 hours', ( select id from profile where description = 'default profile' ) );
...
-- 31/08/2015
insert into day(id, date, expected_hours, id_profile) values (nextval('day_seq'),'2015-08-31', '8 hours', ( select id from profile where description = 'default profile' ) );
...
-- 01/09/2015
insert into day(id, date, expected_hours, id_profile) values (nextval('day_seq'),'2015-09-01', '8 hours', ( select id from profile where description = 'default profile' ) );
